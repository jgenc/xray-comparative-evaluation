...
data_root = "/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray"
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type="CocoDataset",
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray/annotations/train.json",
        img_prefix="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray/images/train",
        pipeline=[
            dict(type="LoadImageFromFile"),
            dict(type="LoadAnnotations", with_bbox=True),
            dict(type="RandomFlip", flip_ratio=0.5),
    ...
    val=dict(
        type="CocoDataset",
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray/annotations/val.json",
        img_prefix="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray/images/val",
        pipeline=[
            dict(type="LoadImageFromFile"),
            dict(
                type="MultiScaleFlipAug",
    ...
    test=dict(
        type="CocoDataset",
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray/annotations/test.json",
        img_prefix="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/CLCXray/images/test",
        pipeline=[
            dict(type="LoadImageFromFile"),
            dict(
                type="MultiScaleFlipAug",
