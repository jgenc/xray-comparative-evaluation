...
_base_ = [
    # '../mmdetection/configs/_base_/datasets/lvis_v1_instance.py',
    '../_base_/datasets/coco_detection.py',
    '../_base_/default_runtime.py',
    # "./co_dino_5scale_vit_large_lvis.py"
]

checkpoint_config = dict(interval=1)
resume_from = None
load_from = "./configs/co_detr_vit/co_dino_5scale_vit_large_lvis.pth"
pretrained = None
...
train_pipeline = [
    ...
    # The lines above are augmentations for the LVIS type dataset, NOT COCO

    # The lines below are taken from the "co_dino_5scale_swin_large_16e_o365tococo.py" file from the repository.
...
data_root = '/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/Ceasefire_4'
