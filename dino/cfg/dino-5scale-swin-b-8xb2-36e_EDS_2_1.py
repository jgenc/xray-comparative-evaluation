...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/EDS/coco/domain1/annotations/train.json",
        backend_args=None,
...
train_dataloader = dict(
    ...
    batch_size=1,
    dataset=dict(
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/EDS/coco/domain2/annotations/train.json",
        backend_args=None,
        data_prefix=dict(img="images/train/"),
        data_root="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/EDS/coco/domain2",
...
work_dir = "./runs/dino-5scale-swin-b-8xb2-36e_EDS_2_1"
