...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/HiXray/coco/annotations/test.json",
        backend_args=None,
...
train_dataloader = dict(
    ...
    batch_size=1,
    dataset=dict(
        ann_file="/home/cv-group/jorgen/ceasefire/ceasefire/Datasets/HiXray/coco/annotations/train.json",
        backend_args=None,
...
work_dir = "runs/SWIN_dino_5scale-swin-b-8xb2-36e_HiXray"
