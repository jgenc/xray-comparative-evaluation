...
class MHCA(nn.Module):
    ...
    def __init__(self, out_channels, head_dim):
        ...
        # print(f"[\x1b[1;312DEBUG\x1b[0m] out_channels: {out_channels}, head_dim: {head_dim}")
        ...
        for stage_id in range(len(depths)):
            ...
            for block_id in range(numrepeat):
                ...
                if block_type is NCB:
                    print(f"Stage {stage_id}, Block {block_id}, NCB")
                    print(f"[{input_channel}, {output_channel}, {stride}, {dpr[idx + block_id]}, {drop}, {head_dim}]")
                    ...
                    print(f"Stage {stage_id}, Block {block_id}, NTB")
                    print(f"[{input_channel}, {output_channel}, {dpr[idx + block_id]}, {stride}, {sr_ratios[stage_id]}, 2, {head_dim}, {mix_block_ratio}, {attn_drop}, {drop}]")
...
class nextvit_small_custom(NextViT):
    def __init__(
        self,
        stem_chs=[64, 32, 64],
        depths=[3, 4, 10, 3],
        ...
        **kwargs
        ...
        super(nextvit_small_custom, self).__init__(
            stem_chs=stem_chs, depths=depths, path_dropout=path_dropout, resume=resume, frozen_stages=frozen_stages, **kwargs)
