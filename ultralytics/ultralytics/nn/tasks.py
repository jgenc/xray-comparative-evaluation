...
class BaseModel(nn.Module):
    ...
    def load(self, weights, verbose=True):
        ...
        # print(f"[\x1b[1;31mDEBUG\x1b[0m] In nn.tasks.BaseModel.load: model: {model.keys()}")
...
class DetectionModel(BaseModel):
    ...
    def __init__(
        ...
        # print(f"[\x1b[1;31mDEBUG\x1b[0m] DetectionModel ch: {ch}")
        ...
        # print(f"[\x1b[1;31mDEBUG\x1b[0m] Trying to build")
        # print(f"[\x1b[1;31mDEBUG\x1b[0m] {self.model}")
        # from torchinfo import summary
        # summary(self.model, input_size=(1, 3, 100, 100))
        # exit()
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(
        ...
        if m in (
            ...
            c1, c2 = ch[f], args[0]
            # if m in (Classify, SPPF):
            #     # print(f"[\x1b[1;31mDEBUG\x1b[0m] Tasks SPPF: c1 {c1}, c2 {c2}, ch: {ch}, f: {f}, ch[f]: {ch[f]}, args[0] {args[0]}")
            # if m is DWConv:
            #     print(
            #         f"[\x1b[1;31mDEBUG\x1b[0m] Tasks DWConv: c1 {c1}, c2 {c2}, ch: {ch}, f: {f}, ch[f]: {ch[f]}, args[0] {args[0]}"
            #     )
            ...
            # print(f"[\x1b[1;31mDEBUG\x1b[0m] HGStem: {c1=}, {cm=}, {c2=}, {args=}")
            if m is HGBlock:
                args.insert(4, n)  # number of repeats
                n = 1
                # print(f"[\x1b[1;31mDEBUG\x1b[0m] HGBlock: {args=}")
        ...
        # NOTE: We have added this
        elif m in (ConvBNReLU, NCB, NTB):
            # print(f"[\x1b[1;31mDEBUG\x1b[0m] f: {f}, n: {n}, m: {m}, args: {args}")
            c2 = args[1]
        elif m is nn.BatchNorm2d:
            args = [ch[f]]
        elif m is Concat or m is UpsampleAdd:
            c2 = sum(ch[x] for x in f)
        elif m is LIM_DFPN:
            c2 = args[0]
        elif m is ManyToOne:
            ...
            c2 = args[0]
        elif m is ResNet101_1 or m is ResNet101_2 or m is ResNet101_3:
            c2 = args[0]
        elif m is EfficientNetV2_1 or m is EfficientNetV2_2 or m is EfficientNetV2_3:
            c2 = args[0]
        elif m is DDoMClf:
            c1, c2 = ch[f], args[0]
            args = [c1, c2, args[1]]
            print(f"[\x1b[1;31mDEBUG\x1b[0m] c1: {c1}, c2: {c2}, args: {args}")
        else:
            c2 = ch[f]
        ...
        if i == 0:
            ch = []
        # print(f"[\x1b[1;31mDEBUG\x1b[0m] DetectionModel_parse_model ch: {ch}, c2: {c2}")
        ch.append(c2)
...
def yaml_model_load(path):
    ...
    # print(f"[\x1b[1;31mDEBUG\x1b[0m] scale: {d.get('scale')}")
